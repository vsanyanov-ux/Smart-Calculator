...
- **LangGraph**: Библиотека для создания сложных циклических графов на базе LLM.
- **LangChain**: Основной фреймворк для взаимодействия с языковыми моделями.
- **OpenRouter**: Универсальный API для доступа к топовым моделям (используется **Gemini 2.0 Flash**).
- **Python-dotenv**: Управление переменными окружения.
- **Mermaid**: Визуализация архитектуры агента.
